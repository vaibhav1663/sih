                ...
                <div className="flex flex-1 flex-col items-center justify-center px-10 relative">
                    ...
                    <div className="flex flex-1 flex-col mt-8 justify-center space-y-5 max-w-md">
                        <div className="flex flex-col space-y-2 text-center">
                            ...
                            <p className="text-md md:text-xl">It'll takes few minutes</p>
                        </div>
                        ...
                        <div className="grid gap-4 sm:grid-cols-2 sm:gap-6" > 
                            ...
                            <input type="text" name="college" id="college" placeholder="College Name" onChange={(e)=>{setCollegeName(e.target.value)}}
                                className="flex px-3 py-2 md:px-4 md:py-3 w-full border-2 border-black rounded-lg font-medium placeholder:font-normal" />
                            </div>
                            ...
                            <div class="w-full">
                                ...
                                <select id="gender" onChange={(e)=>{setGender(e.target.selectedOptions[0].value)}} className="border-2 border-black rounded-lg text-gray-900 text-sm focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 ">
                            ...
                            <div class="w-full">
                                ...
                                <input type="number" onChange={(e)=>{setAge(e.target.value)}} name="age" id="age" className="border-2 border-black rounded-lg text-gray-900 text-sm focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 " placeholder="21" required="" />
                            </div>
                            <div>
                                <label for="stream" class="block mb-2 text-sm font-medium text-gray-900  text-left ">Stream</label>
                                <select id="stream" onChange={(e)=>{setDegree(e.target.selectedOptions[0].value)}}  className="border-2 border-black rounded-lg text-gray-900 text-sm focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 ">
                                    <option selected="">Select category</option>
                            ...
                            <div>
                                ...
                                <select id="year" onChange={(e)=>{setYear(e.target.selectedOptions[0].value)}}  className="border-2 border-black rounded-lg text-gray-900 text-sm focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 ">
                                    <option selected="">Select category</option>
                            ...
                            <div>
                                ...
                                <select id="field" onChange={(e)=>{setField(e.target.selectedOptions[0].value)}}  className="border-2 border-black rounded-lg text-gray-900 text-sm focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 ">
                                    <option selected="">Select category</option>
                            ...
                            <div>
                                ...
                                <select id="role" onChange={(e)=>{setRole(e.target.selectedOptions[0].value)}}  className="border-2 border-black rounded-lg text-gray-900 text-sm focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 ">
                        ...
                        <button type="submit" onClick={handleSubmit} className="flex w-full items-center justify-center flex-none mt-4 px-2 py-2 border-2 rounded-lg font-medium border-black bg-black text-white">
                            Submit
                        </button>
                    </form>

                            <p className=" mb-1">Already have an Account ? <Link className='font-bold' to="/login">Login </Link></p>
                        </div>
